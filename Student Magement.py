...
def Connectdb():
    ...
    '''backlabel = Label(DataEntryFrame, text='----THANKYOU VISIT AGAIN----', width=30,
                       font=('arial', 22, 'italic bold'), bg='darkseagreen')
    backlabel.pack(side=TOP, expand=True)'''
    ...
    SliderLabel = Label(dbroot, text=ss, font=('lucida sans typewriter', 25, 'italic bold'),
                        relief=RIDGE, borderwidth=4, width=26,bg='#8FBC8F')
    ...
    #---------------------------------------------Clock-------------------------------------------------------#
    clock = Label(dbroot, font=('times', 14, 'bold'), relief=RIDGE, borderwidth=4, width=15
                  , bg='lawn green')
    clock.place(x=0, y=0)
    tick()
